    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Daftar putaran hanya tampil 5, scroll jika lebih
          SizedBox(
            height: 250, // Batasi tinggi daftar putaran
            child: Scrollbar(
          ...
          // Tombol tetap di bawah tanpa terpengaruh daftar putaran
          Container(
            margin:
                EdgeInsets.only(top: 30, bottom: 20), // Jaga jarak dari bawah
